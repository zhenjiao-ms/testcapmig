---
title: Test with Beyondsoft
ms.custom: na
ms.reviewer: na
ms.suite: na
ms.tgt_pltfrm: na
ms.assetid: 0353fdd8-40a8-450f-af98-a2647ce76d12
robots: noindex,nofollow
---
# Test with Beyondsoft
Welcome to CAPS Markdown Editor. Glad to be h!
====

CAPS is using GitHub Flavored Markdown(GFM) which is one of the most popular Markdown flavor. Lets' learn how to make your customized document with below rules. Glad to be here....
1. ghjhj
2. hgjhgh
#####
...
![Image description goes here](../Image/Bilingual-Publishing-Topic-Setup.jpg) 
